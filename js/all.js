...
jQuery(document).ready(function ($) {
  ...
  $(".shop-grid.-slider").slick({
    ...
    prevArrow:
      '<span class="arrow -prev"><i class="fa fa-chevron-left"></i></span>',
    responsive: [
      {
        breakpoint: 1400,
        settings: {
  ...
  if ($("#shop-filter_range-slider").length) {
    ...
    $("#shop-filter_range-amount").val(
      "$" +
        $("#shop-filter_range-slider").slider("values", 0) +
        " - $" +
  ...
  if ($("#google-map").length) {
    var uluru = { lat: -20.866816, lng: -49.413831 };
  ...
  if ($("#fullPageLanding").length) {
    $("#fullPageLanding").fullpage({
      ...
      anchors: [
        "section-home-anchor",
        "section-our-story-anchor",
        "section-our-gallery-anchor",
        "section-menu-anchor",
        "section-testimonials-anchor",
        "section-shop-anchor",
        "section-contact-us-anchor",
      ],
      menu: "#myMenu",
  ...
  function galleryAnimation() {
    ...
    $(".modern-slider-wrap .slick-active").hover(
      function () {
    ...
    if ($("#blackMap").length) {
      ...
      function initMap() {
        map = new google.maps.Map(document.getElementById("blackMap"), {
          center: { lat: 40.710683, lng: -74.00718 },
          zoom: 12,
          zoomControl: false,
        ...
        var marker = new google.maps.Marker({
          position: { lat: 40.710683, lng: -74.00718 },
          map: map,
  ...
  if ($(".fullscreen-bg").length) {
    // change BG
    var sectionWelcomeHeight = $(".video-landing .section-welcome").outerHeight(
      true
    );
    var sectionAboutScrollTo = $(".video-landing .our-story-section").position()
      .top;
  ...
  if ($(".main-wrap-content").length) {
    ...
    $(".main-wrap-content, .reservation-btn_wrapper").on(
      "click",
      function (event) {
        controller.close("side-reservation");
      }
  ...
  if ($("#blackAndWhiteMap").length) {
    ...
    function initMap() {
      map = new google.maps.Map(document.getElementById("blackAndWhiteMap"), {
        center: { lat: -20.866816, lng: -49.413831 },
        zoom: 15,
        zoomControl: false,
        disableDefaultUI: true,
        zoomControlOptions: {
      ...
      var marker = new google.maps.Marker({
        position: { lat: -20.866816, lng: -49.413831 },
        map: map,
        title: "Tattoo studio Ink Tattoo",
        animation: google.maps.Animation.BOUNCE,
        icon: icon,
